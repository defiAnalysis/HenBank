...
interface IDToken {
    ...
    event Interest(address indexed src, uint256 interest, uint256 increase, uint256 totalInterest);
    event Mint(address indexed account, uint256 indexed pie, uint256 wad, uint256 totalSupply, uint256 exchangeRate);
    event Redeem(address indexed account, uint256 indexed pie, uint256 wad, uint256 totalSupply, uint256 exchangeRate);

    // --- Admin Triggered Event ---
    event Rebalance(address[] withdraw, uint256[] withdrawAmount, address[] supply, uint256[] supplyAmount);
    ...
    event NewOriginationFee(bytes4 sig, uint256 oldOriginationFeeMantissa, uint256 newOriginationFeeMantissa);
    ...
    function updateOriginationFee(bytes4 _sig, uint256 _newOriginationFee) external;
    ...
    function getCurrentInterest(address _account) external view returns (uint256);
